...
const AnamnesisComponent = ({ anamnesisData }) => {
  ...
  const updateData = async () => {
    try {
      ...
      await axios.patch(
        `${API_URL}/api/v1/records/${anamnesisData.id}/`,
        formData,
        {
          headers: {
  ...
  return (
    <div>
      ...
      <Descriptions bordered>
        <Descriptions.Item label="Добавление">
          {anamnesisData.addition}
        </Descriptions.Item>
        ...
        <Descriptions.Item label="Легкие зазоры">
          {anamnesisData.light_gaps}
        </Descriptions.Item>
        ...
        <Form>
          ...
          <Form.Item label="Потребление алкоголя">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("binge_drinking", e.target.value)
              }
            />
          </Form.Item>
          ...
          <Form.Item label="Ежедневная переносимость">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("daily_tolerance", e.target.value)
              }
            />
          </Form.Item>
          ...
          <Form.Item label="Длительность последнего запоя">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("duration_last_binge", e.target.value)
              }
            />
          </Form.Item>
          <Form.Item label="Длительность последнего обострения">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("duration_last_remission", e.target.value)
              }
            />
          </Form.Item>
          <Form.Item label="Последний приём алкоголя">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("last_alcohol_intake", e.target.value)
              }
            />
          </Form.Item>
          <Form.Item label="Последнее лечение">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("last_treatment", e.target.value)
              }
            />
          </Form.Item>
          ...
          <Form.Item label="Ментальные расстройства">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("mental_disorders", e.target.value)
              }
            />
          </Form.Item>
          <Form.Item label="Принимает что-то">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("receiving_something", e.target.value)
              }
            />
          </Form.Item>
          <Form.Item label="Время приёма">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("receiving_something_time", e.target.value)
              }
            />
          </Form.Item>
          <Form.Item label="Соматические расстройства">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("somatic_disorders", e.target.value)
              }
            />
          </Form.Item>
          <Form.Item label="Тип интоксикации">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("type_intoxication", e.target.value)
              }
            />
          </Form.Item>
          <Form.Item label="Тип палимпсестов">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("type_palimpsests", e.target.value)
              }
            />
          </Form.Item>
          <Form.Item label="Тип переносимости">
            <Input
              ...
              onChange={(e) =>
                handleInputChange("type_tolerance", e.target.value)
              }
            />
          </Form.Item>
        </Form>
